...
(function(a, b, c) {
    ...
    do_related_post_start = function(json) {
        ...
        inject(def.homePage + '/feeds/posts/default' + la + '?alt=json-in-script&orderby=updated&start-index=' + ri + '&max-results=' + def.numPosts + '&callback=do_related_post_' + hash);
    },
...
if (month < 10) {
  month = '0' + month;
    ...
    inject(def.homePage + '/feeds/posts/default?alt=json-in-script&orderby=updated&max-results=0&callback=do_related_post_start_' + hash);
